...
- `.claude/rules/learning.md` contiene trigger operativi anti-errore (35
  regole con ID univoco). **Ogni agente DEVE leggerlo all'inizio della
  sessione** e aggiornarlo se scopre un pattern nuovo o un errore
  significativo
