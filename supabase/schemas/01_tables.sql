...
create table public.deals (
    ...
    contact_id bigint,
    category text,
    -- Fixed to a single value for this proof slice: the Living Example offer.
    -- Structured as a controlled-vocabulary text column (not a free-form field)
    -- so it can be swapped for a real `offer_id` foreign key once a proper
    -- Offer table exists.
    offer text not null default 'the_living_example',
    stage text not null,
    ...
    sales_id bigint,
    index smallint,
    constraint deals_offer_check check (offer in ('the_living_example')),
