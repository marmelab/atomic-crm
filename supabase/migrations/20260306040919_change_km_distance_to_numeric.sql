-- Change km_distance from integer to numeric(10,2) to support decimal distances
-- from the travel route calculator (e.g. 212.47 km).
...
ALTER TABLE services
  ALTER COLUMN km_distance TYPE numeric(10,2) USING km_distance::numeric(10,2);
...
-- Recreate analytics_yearly_competence_revenue
