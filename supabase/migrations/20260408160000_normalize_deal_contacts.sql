-- Phase 2 Wave 2.3A: Normalize deals.contact_ids to deal_contacts join table
-- The deals.contact_ids bigint[] column is kept for dual-write compatibility.

BEGIN;

-- ============================================================
-- 1. Create deal_contacts join table
-- ============================================================
...
CREATE POLICY "authenticated_all_deal_contacts" ON public.deal_contacts
    FOR ALL TO authenticated
    USING (auth.uid() IS NOT NULL)
    WITH CHECK (auth.uid() IS NOT NULL);

-- ============================================================
-- 3. Migrate existing data from deals.contact_ids array
-- ============================================================
...
-- ============================================================
-- 4. Update merge_contacts to handle deal_contacts join table
-- ============================================================
