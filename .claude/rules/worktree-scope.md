...
| `${TICKETS_DIR}/reviews/FEATURE-quality-reviewer` | ✅ | ⚠️ quality-reviewer in `MODE: feature-review` ONLY: `touch` on APPROVED / `rm -f` on BLOCKED. This flag is what gates the end-of-feature e2e hook. | — |
