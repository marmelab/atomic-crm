...
Reading `e2e-result.json` is MANDATORY before promotion / handoff: it is the only place the suite's verdict exists, and skipping the read is what would make a red suite "silently swallowed".
