...
The mobile app also supports offline mode, allowing you to access your data and perform actions even when you don't have an internet connection. 
...
You can also create new notes and tasks while offline, and they will be synced with the server once you regain an internet connection.