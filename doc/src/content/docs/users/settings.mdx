...
The deal stage with the value `lost` has a special behavior: moving a deal to it, either by dragging the card in the Kanban view or by picking it in the deal form, requires a reason explaining why the deal was lost. You can rename its label freely, but if you delete this stage, deals can no longer be marked as lost with a reason.