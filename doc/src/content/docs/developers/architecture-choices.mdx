...
The Atomic CRM code primarily lives in the `src/atomic-crm` directory. With less than 15,000 lines of code, it is a small codebase that can be easily customized.
