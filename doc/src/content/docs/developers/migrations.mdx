...
| `02b_private_functions.sql` | `SECURITY DEFINER` helpers in the `private` schema, kept out of the exposed API |
...
| `08_extensions.sql` | Extensions deliberately not installed (not covered by `db diff`) |
