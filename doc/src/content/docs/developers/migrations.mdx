...
:::caution
Never edit migration files in `supabase/migrations/` directly. They are auto-generated from the schema files and should be treated as build artifacts.
:::
...
4. **Verify** the diff is clean (no remaining differences):
