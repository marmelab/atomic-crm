...
The language switcher appears in the Profile page when more than one locale is configured. See [Preferences](../../users/preferences#changing-your-language) for the end-user point of view.
