...
Atomic CRM language configuration is managed in `src/components/atomic-crm/providers/i18nProvider.tsx`.
...
2. Edit `src/components/atomic-crm/providers/i18nProvider.tsx` and add the locale to `availableLocales`.
