...
npx supabase secrets set POSTMARK_INBOUND_EMAIL=<your-postmark-inbound-email> # Optional, only needed if you want to to be able to transfer mail directly to the CRM
```
...
POSTMARK_INBOUND_EMAIL=<your-postmark-inbound-email> # Optional, only needed if you want to to be able to transfer mail directly to the CRM
```
