...
- `GET /rest/v1/companies?id=eq.{id}`: to get a company by id.
...
- `GET /rest/v1/contacts?id=eq.{id}`: to get a contact by id.
...
- `GET /rest/v1/tasks?id=eq.{id}`: to get a task by id.
...
- `GET /rest/v1/deals?id=eq.{id}`: to get a deal by id.
...
- `GET /rest/v1/deal_notes?id=eq.{id}`: to get a deal note by id.
...
- `GET /rest/v1/contact_notes?id=eq.{id}`: to get a contact note by id.
