...
- 2026-03-06: Comprehensive mobile layout audit — fix all Create/Edit/Show pages (flex-col, mb-28, responsive titles, Settings bottom padding, PDF preview overflow)
