...
export const ContactListFilter = () => {
  ...
  return (
    <ResponsiveFilters
      searchInput={{
        placeholder: translate("crm.contacts.search_name_company", {
    ...
    >
      ...
      <FilterCategory
        label={translate("resources.tags.name", { smart_count: 2, _: "Tags" })}
        icon={<Tag />}
      >
        {data &&
          data.map((record) => (
      ...
      >
        <ToggleFilterButton
          ...
          label={translate("crm.contacts.filters.with_pending_tasks", {
