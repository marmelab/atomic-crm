export const englishCrmMessages = {
  resources: {
    companies: {
      ...
      fields: {
        ...
        registration_number: "Registration Number (CoI No.)",
        entity_type: "Entity Type",
        vat_registered: "VAT Registered",
        vat_filing_frequency: "VAT Filing Frequency",
        paye_registered: "PAYE Registered",
        sdl_registered: "SDL Registered",
        provisional_tax_registered: "Provisional Tax Registered",
        ...
        trading_license_expiry: "Trading License Expiry",
        tax_clearance_certificate_expiry: "Tax Clearance Certificate Expiry",
      },
      empty: {
      ...
      field_categories: {
        ...
        address: "Address",
        context: "Context",
        eswatini_compliance: "Eswatini Compliance",
      },
      entity_types: {
    ...
    contacts: {
      ...
      field_categories: {
        ...
        position: "Position",
        eswatini_identifiers: "Eswatini Identifiers",
      },
      fields: {
        ...
        role_at_company: "Role at Company",
      },
      action: {
        add: "Add contact",
    ...
    deals: {
      name: "Potential client |||| Potential clients",
      fields: {
        name: "Name",
        description: "Description",
        company_id: "Company",
      ...
      action: {
        back_to_deal: "Back to potential client",
        create: "Create potential client",
        new: "New Potential Client",
      },
      field_categories: {
        misc: "Misc",
      },
      archived: {
        action: "Archive",
        error: "Error: potential client not archived",
        list_title: "Archived Potential Clients",
        success: "Potential client archived",
        title: "Archived Potential Client",
        view: "View archived potential clients",
      },
      inputs: {
        linked_to: "Linked to",
      },
      unarchived: {
        ...
        error: "Error: potential client not unarchived",
        success: "Potential client unarchived",
      },
      updated: "Potential client updated",
      empty: {
        before_create: "before creating a potential client.",
        description: "It seems your potential clients list is empty.",
        title: "No potential clients found",
      },
    ...
    compliance_filings: {
      name: "Compliance Filing |||| Compliance Calendar",
      fields: {
        company_id: "Company",
    ...
    time_entries: {
      ...
      fields: {
        ...
        hours: "Hours",
        billable: "Billable",
        hourly_rate_szl: "Rate (E/hr)",
        service_line: "Service Line",
        description: "Description",
        linked_filing_id: "Linked Filing",
        invoice_id: "Invoice",
      },
      service_lines: {
        TAX: "Tax",
  ...
  crm: {
    ...
    auth: {
      ...
      welcome_title: "Welcome to Practice-CRM",
    },
    common: {
      activity: "Activity",
      added: "added",
    ...
    profile: {
      inbound: {
        description:
          "You can start sending emails to your server's inbound email address, e.g. by adding it to the %{field} field. Practice-CRM will process the emails and add notes to the corresponding contacts.",
        title: "Inbound email",
      },
      mcp: {
        title: "MCP Server",
    ...
    compliance: {
      ...
      generated_success:
        "Generated %{count} filing |||| Generated %{count} filings",
      generated_error: "Failed to generate filings. Please try again.",
      view_list: "List",
    ...
    time_billing: {
      entry_saved: "Time entry saved",
      entry_save_error: "Failed to save time entry. Please try again.",
      invoice_created: "Invoice %{number} created as DRAFT",
      invoice_create_error: "Failed to create invoice. Please try again.",
      no_entries_in_range:
        "No uninvoiced billable entries found in that date range.",
    },
    validation: {
