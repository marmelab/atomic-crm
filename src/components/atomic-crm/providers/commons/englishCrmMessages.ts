export const englishCrmMessages = {
  ...
  crm: {
    ...
    programs: {
      ...
      opening_over_committed: "%{count} more starting than there is room for",
      ...
      runs_until: "%{start} — ends %{end}",
      runs_expected: "%{start} — expected to end %{month}",
      starts_only: "Starts %{start}",
      no_start_recorded: "Start date not set",
