import { fetchWithTimeout } from "@/components/atomic-crm/misc/fetchWithTimeout";
import { DOMAINS_NOT_SUPPORTING_FAVICON } from "@/components/atomic-crm/misc/unsupportedDomains.const";
