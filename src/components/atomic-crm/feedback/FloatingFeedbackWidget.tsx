    ...
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        <Button
          ...
          className="fixed bottom-6 right-6 z-50 h-14 w-14 cursor-pointer rounded-full shadow-lg"
        >
          {open ? (
            <X className="h-6 w-6" />
          ) : (
      ...
      <PopoverContent
        ...
        side="top"
        sideOffset={12}
        className="z-50 flex h-[32rem] w-96 max-w-[calc(100vw-2rem)] flex-col p-0"
      >
