...
import { type Identifier, useTranslate } from "ra-core";
          ...
          <CardContent className="px-6">
            <div className="flex items-center justify-between mb-8">
              <h3 className="text-lg font-bold">
                {translate("crm.onboarding.whats_next", { _: "What's next?" })}
              </h3>
              <div className="w-[150px]">
                <Progress value={(step / 3) * 100} className="mb-2" />
                <div className="text-right text-sm">
                  {translate("crm.onboarding.done_count", {
                    step,
                    _: `${step}/3 done`,
                  })}
                </div>
            ...
            <div className="flex flex-col gap-12">
              <div className="flex gap-8 items-center">
                ...
                <h4 className="font-bold">
                  {translate("crm.onboarding.install", {
              ...
              <div className="flex gap-8 items-start">
                ...
                <div className="flex flex-col gap-4">
                  <h4 className="font-bold">
                    {translate("crm.onboarding.add_first_contact", {
                  ...
                  <div className="flex gap-8">
                    {isMobile ? (
                      ...
                      >
                        ...
                        {translate("crm.contacts.new_contact", {
                          _: "New Contact",
                        })}
                      </Button>
                    ) : (
                      <>
                        <CreateButton
                          label="crm.contacts.new_contact"
                          resource="contacts"
                        />
                        <ContactImportButton />
                      </>
              ...
              <div className="flex gap-8 items-start">
                ...
                <div className="flex flex-col gap-4">
                  <h4 className="font-bold">
                    {translate("crm.onboarding.add_first_note", {
                      _: "Add your first note",
                    })}
                  </h4>
                  <p>
                    {translate("crm.onboarding.go_to_contact_add_note", {
                  ...
                  {isMobile ? (
                    ...
                    >
                      <Plus className="h-4 w-4" />
                      {translate("crm.onboarding.add_note", { _: "Add note" })}
                    </Button>
                  ) : (
