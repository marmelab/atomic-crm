...
// Backs the Enrollment/Client page (Contracts + Onboarding slice) — same
// "walk the Opportunity to its Contact/Offer/Cohort" shape as
// useApplicationReviewData.ts, extended with the checklist itself and its
// linked Tasks, everything the page needs to be the real onboarding
// operational home: payment context (from the Deal's own frozen snapshot),
// the checklist, and any Task still open for an incomplete item.
