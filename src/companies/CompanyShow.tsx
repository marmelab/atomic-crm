...
import { useReferenceManyCount } from "../misc/useReferenceManyCount";
...
const CompanyShowContent = () => {
  ...
  const nb_contacts = useReferenceManyCount({
    reference: "contacts",
    target: "company_id",
  });
  const nb_deals = useReferenceManyCount({
    reference: "deals",
    target: "company_id",
  });
          ...
          <CardContent>
            ...
            >
              {nb_contacts && (
                <Tab
                  label={
                    nb_contacts === 1 ? "1 Contact" : `${nb_contacts} Contacts`
                  }
                />
              )}
              {nb_deals && (
                <Tab label={nb_deals === 1 ? "1 deal" : `${nb_deals} Deals`} />
              )}
            </Tabs>
            <Divider />
