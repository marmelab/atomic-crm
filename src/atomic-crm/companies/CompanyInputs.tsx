    ...
    return (
        <div className="flex flex-col gap-4">
            ...
            <TextInput
                ...
                labelInline
            />
            <TextInput source="phone_number" helperText={false} labelInline />
        </div>
    );
};
    ...
    return (
        <div className="flex flex-col gap-4">
            ...
            <SelectInput
                ...
                labelInline
            />
            <TextInput source="revenue" helperText={false} labelInline />
            <TextInput source="tax_identifier" helperText={false} labelInline />
        </div>
    );
};
...
const CompanyAddressInputs = () => {
    return (
        <div className="flex flex-col gap-4">
            ...
            <TextInput source="address" helperText={false} labelInline />
            <TextInput source="city" helperText={false} labelInline />
            <TextInput source="zipcode" helperText={false} labelInline />
            <TextInput source="stateAbbr" helperText={false} labelInline />
            <TextInput source="country" helperText={false} labelInline />
        </div>
    );
};
