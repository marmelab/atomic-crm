...
import { CandidateImportSchema, useCandidateImport } from './useCandidateImport';
...
type CandidateImportModalProps = {
    open: boolean;
    onClose(): void;
};
...
export function CandidateImportDialog({
    ...
    const processBatch = useCandidateImport();
    const { importer, parseCsv, reset } = usePapaParse<CandidateImportSchema>({
        batchSize: 10,
        processBatch,
    });
                    ...
                    <Stack spacing={2}>
                        ...
                        {importer.state === 'complete' && (
                            <Alert severity="success">
                                Candidates import complete. Imported{' '}
                                {importer.importCount} candidates, with{' '}
                                ...
                                <Alert
                                    ...
                                    action={
                                        <Button
                                            ...
                                            color="info"
                                            to={SAMPLE_URL}
                                            download={'crm_candidates_sample.csv'}
                                        />
                                    }
                                >
