...
After the orchestrator returns from a `#technical-harness` run, the main thread runs `/harness-diff` to show the net diff of the session branch it stopped on.
