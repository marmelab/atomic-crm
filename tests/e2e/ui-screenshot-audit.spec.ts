...
test.describe("UI Screenshot Audit", () => {
  ...
  test("Clients list screenshot", async ({ page }) => {
    ...
    await page.screenshot({ path: "test-results/audit-clients.png", fullPage: true });
  });
  ...
  test("Projects screenshot", async ({ page }) => {
    ...
    await page.waitForTimeout(500);
    await page.screenshot({ path: "test-results/audit-projects.png", fullPage: true });
  });
  ...
  test("Services screenshot", async ({ page }) => {
    ...
    await page.waitForTimeout(500);
    await page.screenshot({ path: "test-results/audit-services.png", fullPage: true });
  });
  ...
  test("Payments screenshot", async ({ page }) => {
    ...
    await page.waitForTimeout(500);
    await page.screenshot({ path: "test-results/audit-payments.png", fullPage: true });
  });
  ...
  test("Expenses screenshot", async ({ page }) => {
    ...
    await page.waitForTimeout(500);
    await page.screenshot({ path: "test-results/audit-expenses.png", fullPage: true });
  });
  ...
  test("AI Chat screenshot", async ({ page }) => {
    ...
    await page.waitForTimeout(500);
    await page.screenshot({ path: "test-results/audit-ai-chat.png", fullPage: true });
  });
});
